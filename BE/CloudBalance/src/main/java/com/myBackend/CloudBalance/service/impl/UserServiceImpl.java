...
//    private final UserMapper userMapper;
    ...
    public List<UserResponseDTO> getAllUsers() {
        ...
        List<UserResponseDTO> usersDTO =
                users.stream().map(currentUser -> new UserResponseDTO(currentUser.getEmail(), currentUser.getFirstName(),currentUser.getLastName(), currentUser.isUserActive(), currentUser.getLastLogin(),currentUser.getRole()))
                        .toList();
